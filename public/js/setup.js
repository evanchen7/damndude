...
// ßNOTE: Took off the above code. It was setting headers for Parse API.

//-------------- BEGIN VARIABLE/FUNCTION DECLARATIONS ---------------------

// var SERVER_URL = 'http://parse.shared.hackreactor.com/chatterbox/classes/messages';

var SERVER_URL = 'http://10.8.160.235:3000/classes/messages';
              // NOTE: Added http and it started actually sending requests.
...
// This one sends a POST req to the Parse server to send a message.
var postData = function(message, username) {
  var obj = {results : [message]};
  $.ajax({
    url: SERVER_URL,
    contentType: 'application/json',
    type: 'POST',
